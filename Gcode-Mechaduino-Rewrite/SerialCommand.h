...
#define __SERIALCOM_H__
  ...
  #define COMMAND_SIZE   128   // Commands are 127 characters long (at most); we need to terminate with a null
  #define CODE_LEN       32    // Each code has at most 32 characters (e.g. speed or length to move)
